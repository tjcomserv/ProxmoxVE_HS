...
service:
  ...
  tjcomserv/ProxmoxVE_HS:
    latest_version:
      type: github
      url: tjcomserv/ProxmoxVE_HS
      use_prerelease: false
    dashboard:
      icon: https://raw.githubusercontent.com/tjcomserv/ProxmoxVE_HS/refs/heads/main/misc/images/logo.png
      icon_link_to: https://helper-scripts.com/
      web_url: https://github.com/tjcomserv/ProxmoxVE_HS/releases
EOF
